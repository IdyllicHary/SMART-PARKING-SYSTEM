            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6">
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            <h5>2022</h5>
                            <p>Achieved over 500 thousand successful parking sessions</p>
                        </div>
                        <div class="timeline-item">
                            <h5>2023</h5>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <img src="assets/images/stephen.jpg" alt="User 1" class="testimonial-img">
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <img src="assets/images/melvin.jpg" alt="User 2" class="testimonial-img">
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <img src="assets/images/hillarry.jpg" alt="User 3" class="testimonial-img">
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                const milestones = [
                    { id: 'milestone1', end: 500000, isPercentage: false }, // 500K+ Parking Sessions
